...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        mLocationRequest.setPriority(LocationRequest.PRIORITY_HIGH_ACCURACY);  //TODO: Drains the battery, may need to change to lower accuracy.
        ...
        //If we don't call this method, we will get the location only once.
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.d("mLastLocation: ", String.valueOf(mLastLocation.getLatitude())+", "+String.valueOf(mLastLocation.getLongitude()));
